...
import com.voiceassistent.dataBase.DBHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Открытие приложения после полного его завершения
        ...
        if (savedInstanceState==null){
            ...
            cursor.close();
            //добавление сообщений из базы данных
        }
    ...
    //при полной остановки приложения
    @Override
